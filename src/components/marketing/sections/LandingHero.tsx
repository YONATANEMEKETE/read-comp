...
const LandingHero = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center px-6 pt-24 pb-12 bg-[#FDFBF7] dark:bg-[#1C1917] overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#D97706]/10 dark:bg-[#D97706]/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[20%] right-[-5%] w-[30%] h-[30%] bg-[#B45309]/10 dark:bg-[#B45309]/5 rounded-full blur-[80px] pointer-events-none" />
      <div className="absolute top-[30%] right-[10%] w-[15%] h-[15%] bg-[#D97706]/5 dark:bg-[#D97706]/5 rounded-full blur-[60px] pointer-events-none" />

      <div className="relative z-10 max-w-screen-xl w-full flex flex-col items-center text-center">
        {/* Abstract Icon */}
        ...
        {/* Hero Title */}
        <h1 className="text-5xl sm:text-6xl md:text-8xl font-black tracking-tighter text-[#1c1917] dark:text-[#fafaf9] mb-6 md:mb-8 uppercase max-w-5xl px-2 leading-[0.95]">
          READ. THINK. NOTE.
          <br />
